    ...
    Paint.prototype = {
        generate: function () {
            ...
            function createCanvas(name) {
                ...
                _this['$' + canvasName]
                    ...
                    .css({height:_this.heightHtml.toString()+'px !important',width:_this.widthHtml.toString()+'px !important'});
        ...
        getImage: function (withBg) {
            ...
            $(canvasSave)
                ...
                .css({height:this.heightHtml.toString()+'px !important',width:this.widthHtml.toString()+'px !important'});
    ...
    Menu.prototype = {
        ...
        reset: function () {
            ...
            for (key in menu.items) {
                console.log(key);
                if(key == 'diamond' || key == 'loadFg' || key == 'loadBg' || key == 'bucket' || key == 'rectangle' || key == 'ellipse' || key == 'circle' || key == 'roundedRect' || key == 'square' || key == 'pentagon' || key == 'hexagon' || key == 'roundedSquare')
                    continue;
