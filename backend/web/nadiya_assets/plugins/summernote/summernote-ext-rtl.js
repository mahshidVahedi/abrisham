    ...
    $.extend($.summernote.plugins, {
        ...
        'rtl': function(context) {
            ...
            context.memo('button.rtl', function() {
                ...
                var button = ui.button({
                    contents: '<div style="direction: ltr"><i class="fa fa-paragraph"/><i class="fa fa-caret-left"/></div>',
        ...
        'ltr': function(context) {
            ...
            context.memo('button.ltr', function() {
                // create button
                var button = ui.button({
                    contents: '<div style="direction: ltr"><i class="fa fa-caret-right"/><i class="fa fa-paragraph"/></div>',
