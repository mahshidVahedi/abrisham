(function(window){
  ...
  var RECORDER_WORKER_PATH  = '/backend/web/nadiya_assets/plugins/jsVoiceRecorder/js/recorderWorker.js';
  var ENCODER_WORKER_PATH   = '/backend/web/nadiya_assets/plugins/jsVoiceRecorder/js/mp3Worker.js';
